...
API_STOP_PORT=7765
API_STOP_KEY=fusion
API_JAVA_OPTIONS=(-Xmx2g -Xss256k -Xms2g -XX:MaxPermSize=256m -Dapple.awt.UIElement=true)

CONNECTORS_PORT=8984
CONNECTORS_STOP_PORT=7984
CONNECTORS_STOP_KEY=fusion
CONNECTORS_JAVA_OPTIONS=(-Xmx3g -Xss256k -Xms3g -XX:MaxPermSize=256m -Dapple.awt.UIElement=true)

SOLR_PORT=8983
SOLR_STOP_PORT=7983
SOLR_STOP_KEY=fusion
SOLR_JAVA_OPTIONS=(-Xmx4g -Xss256k -Xms4g -Dapple.awt.UIElement=true)

UI_PORT=8764
UI_STOP_PORT=7764
UI_STOP_KEY=fusion
UI_JAVA_OPTIONS=(-Xmx512m -Xms512m -XX:MaxPermSize=256m -Dapple.awt.UIElement=true)
...
FUSION_ZK=10.174.17.196:2181,10.174.17.194:2181,10.174.17.193:2181
FUSION_SOLR_ZK=10.174.17.196:2181,10.174.17.194:2181,10.174.17.193:2181
