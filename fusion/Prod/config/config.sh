...
API_STOP_PORT=7765
API_STOP_KEY=fusion
API_JAVA_OPTIONS=(-Xmx2g -Xss256k -Xms2g -XX:MaxPermSize=256m -Dapple.awt.UIElement=true -javaagent:/gsa/newrelic/newrelic.jar)

CONNECTORS_PORT=8984
CONNECTORS_STOP_PORT=7984
CONNECTORS_STOP_KEY=fusion
CONNECTORS_JAVA_OPTIONS=(-Xmx2g -Xss256k -Xms2g -XX:MaxPermSize=256m -Dapple.awt.UIElement=true -javaagent:/gsa/newrelic/newrelic.jar)

SOLR_PORT=8983
SOLR_STOP_PORT=7983
SOLR_STOP_KEY=fusion
SOLR_JAVA_OPTIONS=(-Xmx17g -Xss256k -Xms17g -Dapple.awt.UIElement=true -javaagent:/gsa/newrelic/newrelic.jar)

UI_PORT=8764
UI_STOP_PORT=7764
UI_STOP_KEY=fusion
UI_JAVA_OPTIONS=(-Xmx512m -Xms512m -XX:MaxPermSize=256m -Dapple.awt.UIElement=true -javaagent:/gsa/newrelic/newrelic.jar )
...
FUSION_ZK=10.173.0.45:2181,10.173.0.209:2181,10.173.0.238:2181
FUSION_SOLR_ZK=10.173.0.45:2181,10.173.0.209:2181,10.173.0.238:2181
